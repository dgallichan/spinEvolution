% PROCESS_OPTIONS_STRUCT - Processes options passed to a Matlab function.
...
% Based on process_options code by Mark A. Paskin
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [optStruct] = process_options_struct(optStruct, varargin)
...
%opt_names = cell(1, opts);
for i=1:2:n
  opt_name = varargin{i};
  opt_value = varargin{i+1};
  if ~isfield(optStruct,opt_name)
      optStruct = setfield(optStruct,opt_name,opt_value);
  end
end
